jQuery.fn.responsivePaginate = function () {
    ...
    function responsivePaginate($container) {
        ...
        this.toHtml = function () {
            if (this.linkCount < 1)
                return;
            var html = "<a href='" + this.links[0].href + "' style='visibility:visible;' class='prev'>&nbsp;&nbsp;</a>";
            html = this.appendHtml(html, this.lowerSkip, this.lowerTo); /* 낮은 수 범위 */
            /*html += "<div style='visibility:visible;'>...</div>";
            html = this.appendHtml(html, this.upperSkip, this.upperTo); 높은 수 범위 */
            html += "<a href='" + this.links[this.linkCount - 1].href + "' style='visibility:visible;' class='next'>&nbsp;&nbsp;</a>";
            this.$this.html(html);
        }
